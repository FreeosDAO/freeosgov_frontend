...
<div class="intro-info text-center q-pa-lg">
    <div class="intro-info" v-if="currentIteration && currentIteration.iteration_number >= 0">
    ...
    <div v-if="currentIteration && currentIteration.iteration_number >= 0 && nextIteration && !nextIteration.iteration_number">
        <div class="text-h4 text-weight-medium q-mb-none">Welcome, the</div>
        <div class="text-h3 text-weight-medium text-primary q-mb-none">Freeos AirClaim</div>
