...
export default {
    ...
    computed: {
        ...mapGetters('freeos', ['accountName', 'accountType', 'bcUnstaking', 'XPRBalance', 'liquidFreeos', 'isAuthenticated', 'stakeRequirement', 'stakeRequirementKYC', 'userHasStaked', 'userStake', 'userMeetsStakeRequirement', 'currentIteration','unstakingIteration']),
      stakeIterationMsg () {
